...
const faqs = [
  ...
  { q: "Why is the limited offer RM 799 (excluding 8% SST) when the international rate is RM 12,000+?", a: "We're building our first community of AI engineers in Malaysia. In exchange for your commitment, attendance and feedback, you get the international curriculum at a nominal fee. Future cohorts will be priced at RM 4,000+." },
