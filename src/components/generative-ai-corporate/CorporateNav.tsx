...
const CorporateNav = () => (
  <nav className="section-x fixed inset-x-0 top-0 z-50 flex h-14 items-center border-b border-white/[0.06] bg-obsidian/90 backdrop-blur-xl">
    <Link
      ...
      aria-label="Back to Agentic AI home"
    >
    ...
    <div className="ml-auto flex min-w-0 shrink items-center gap-2 sm:gap-5">
      <Link to="/" className="nav-academy-link hidden md:inline-flex">
        <ArrowLeft className="nav-academy-link__icon h-3.5 w-3.5 shrink-0" aria-hidden />
        <span className="nav-academy-link__text">Agentic AI Home</span>
      </Link>
      <a href="#overview" className="hidden md:inline text-[0.7rem] tracking-wider text-white/40 hover:text-white/80 transition-colors">
        Overview
      </a>
      <a href="#scenarios" className="hidden md:inline text-[0.7rem] tracking-wider text-white/40 hover:text-white/80 transition-colors">
        Scenarios
      </a>
      <a href="#journey" className="hidden md:inline text-[0.7rem] tracking-wider text-white/40 hover:text-white/80 transition-colors">
        Journey
      </a>
      <a href="#enquire" className="hidden md:inline text-[0.7rem] tracking-wider text-white/40 hover:text-white/80 transition-colors">
        Enquire
      </a>
      <a
        href={WHATSAPP_HREF}
